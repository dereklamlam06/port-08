...
<main class="flex-1 py-16 px-6 md:px-12 max-w-7xl mx-auto w-full font-sans text-[#1A1A2E] bg-[#FAFAF7] relative">
    <div class="max-w-7xl mx-auto space-y-16">
        ...
        <div class="text-center max-w-2xl mx-auto space-y-4">
            ...
            <p class="text-xs sm:text-sm text-gray-550 leading-relaxed max-w-md mx-auto">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
            ...
            <div class="border border-gray-200 bg-white rounded-lg p-6 md:p-8 flex flex-col justify-between relative shadow-sm transition-all duration-300 hover:shadow-md">
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <p class="text-xs text-gray-550 leading-relaxed min-h-[40px]">
                ...
                <div class="pt-8">
                    <button onclick="openCheckout('SEO Starter', 15000000)" class="w-full text-center text-xs font-bold uppercase tracking-wider py-3.5 rounded bg-[#F4F4F1] hover:bg-gray-200 text-[#1A1A2E] border border-gray-300 shadow-sm hover:shadow transition-all hover:-translate-y-0.5 cursor-pointer animate-none">
                        Đăng Ký Khởi Chạy
                    </button>
                </div>
            </div>
            ...
            <div class="border border-[#FFD700] derek-gold-card ring-2 ring-[#FFD700]/20 rounded-lg p-6 md:p-8 flex flex-col justify-between relative shadow-md transition-all duration-300 hover:shadow-lg -translate-y-1">
                ...
                <div class="pt-8">
                    <button onclick="openCheckout('SEO Pro', 35000000)" class="w-full text-center text-xs font-bold uppercase tracking-wider py-3.5 rounded bg-[#1A1A2E] hover:bg-neutral-800 text-white shadow-sm hover:shadow transition-all hover:-translate-y-0.5 cursor-pointer animate-none">
                        Đăng Ký Khởi Chạy
                    </button>
                </div>
            </div>
            ...
            <div class="bg-[#1A1A2E] text-[#E2E3E0] border border-gray-800 rounded-lg p-6 md:p-8 flex flex-col justify-between relative shadow-sm transition-all duration-300 hover:shadow-md">
                ...
                <div class="pt-8">
                    <button onclick="openCheckout('AI & Automation', 60000000)" class="w-full text-center text-xs font-bold uppercase tracking-wider py-3.5 rounded bg-[#FFD700] hover:bg-[#E6C200] text-[#1A1A2E] shadow-sm hover:shadow transition-all hover:-translate-y-0.5 cursor-pointer animate-none">
                        Đăng Ký Khởi Chạy
                    </button>
                </div>
            </div>
                        ...
                        <div class="border border-[#FFD700] derek-gold-card ring-2 ring-[#FFD700]/20 rounded-lg p-6 md:p-8 flex flex-col justify-between relative shadow-md transition-all duration-300 hover:shadow-lg -translate-y-1">
                            ...
                            <div class="space-y-6">
                                <div class="space-y-2">
                                    ...
                                    <p class="text-xs text-gray-550 leading-relaxed min-h-[40px]"><?php echo get_the_excerpt(); ?></p>
                                </div>
                                <div class="border-t border-b py-4 border-gray-200/50 flex items-baseline gap-1.5 matches">
        ...
        <!-- Trust Disclaimer -->
        <p class="text-center text-xs text-gray-400 italic font-medium">
            ...
            <div class="space-y-4">
                ...
                foreach ($faqs as $i => $faq) {
                    ...
                    <div class="border-b border-gray-100 pb-4">
                        ...
                        <div id="faq-answer-<?php echo $idx; ?>" class="hidden overflow-hidden mt-2 text-xs text-gray-550 leading-relaxed pl-6 transition-all duration-300">
            ...
            <div class="p-6 md:p-8 flex-1 overflow-y-auto max-h-[500px]">
                ...
                <div id="checkout-step-1" class="space-y-4">
                    ...
                    <div class="pt-2 border-t border-gray-200">
                        ...
                        <p id="coupon-success-msg" class="text-[11px] text-green-600 font-semibold mt-1 hidden font-sans">Đã áp dụng giảm giá 10% thành công!</p>
                ...
                <div id="checkout-step-3" class="space-y-6 text-center hidden">
                    ...
                    <div id="receipt-qr-flow-box" class="bg-[#F5F0E8] border border-gray-200 p-4 rounded-lg space-y-4 max-w-sm mx-auto">
                        ...
                        <div class="text-[11px] text-left space-y-1.5 text-gray-700 font-sans">
                            <p>● Ngân hàng: <strong class="text-gray-900">MOCK COMMERCIAL BANK</strong></p>
                    ...
                    <p class="text-xs text-gray-550 leading-normal max-w-md mx-auto font-medium">
...
<script>
    ...
    function submitSimulatedPayment() {
        ...
        fetch("/api/orders", {
            ...
            goToStep(3); // fallback on preview standalone if server mock disconnects
        });
    }
</script>
