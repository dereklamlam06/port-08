<?php
/**
 * Template Name: Derek Flow Blog Webpage
 */
get_header(); ?>
...
<main class="flex-1 py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full font-sans text-gray-800">
    ...
    <section class="text-center space-y-4 mb-14 relative z-10 max-w-3xl mx-auto">
        <div class="inline-flex items-center gap-2 bg-[#FFD700]/10 border border-[#FFD700]/25 px-3 py-1.5 rounded-full text-[10px] font-extrabold uppercase tracking-widest text-[#1A1A2E]">
            ...
            <span>Chuyên Trang Chia Sẻ Chuyên Sâu • Blog</span>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-150 p-4 sm:p-6 mb-10 shadow-sm relative z-10">
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 items-center">
            ...
            <div class="lg:col-span-8 flex flex-wrap gap-2 items-center">
                ...
                echo '<a href="'.$all_url.'" class="px-3.5 py-1.5 sm:px-4 sm:py-2 text-[11px] font-bold rounded-lg transition-all uppercase tracking-wider bg-navyPrimary text-goldAccent shadow-sm">Tất cả</a>';

                foreach ($categories as $category) {
                    echo '<a href="' . esc_url(get_category_link($category->term_id)) . '" class="px-3.5 py-1.5 sm:px-4 sm:py-2 text-[11px] font-bold rounded-lg transition-all uppercase tracking-wider bg-[#FAFAF7] hover:bg-gray-100 text-gray-700">' . esc_html($category->name) . '</a>';
                }
                ?>
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative z-10">
        ...
        <div class="lg:col-span-8 flex flex-col space-y-6">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-[#FAFAF7] border border-gray-150 rounded-xl px-4 py-2.5 text-xs text-gray-655">
                    ...
                    <article class="post-item-card bg-white rounded-xl border border-gray-150 overflow-hidden shadow-xs hover:shadow-md hover:-translate-y-1 transition-all duration-300 flex flex-col h-full cursor-pointer" onclick="window.location.href='<?php the_permalink(); ?>'">
                        ...
                        <div class="p-4 flex-1 flex flex-col justify-between space-y-3">
                            <div class="space-y-1.5 min-w-0">
                                ...
                                <div class="text-xs text-gray-550 leading-normal line-clamp-2 summary-text">
                                    <?php the_excerpt(); ?>
                                </div>

                                <div class="flex flex-wrap gap-1 pt-0.5 tag-row font-mono">
                                    <?php 
                                    $tags = get_the_tags();
                                    if ($tags) {
                                        $cnt = 0;
        ...
        <aside class="col-span-12 lg:col-span-4 space-y-6">
            ...
            <?php if (!is_active_sidebar('sidebar-primary')) : ?>
                ...
                <section class="bg-white border border-gray-150 p-6 rounded-xl shadow-xs space-y-4">
                    <h4 class="text-xs font-black uppercase tracking-widest text-[#1A1A2E] border-b border-gray-100 pb-3 block">Chuyên Gia Công Nghệ</h4>
                ...
                <section class="bg-white border border-gray-150 p-6 rounded-xl shadow-xs space-y-4">
                    ...
                    <div class="flex flex-col space-y-2.5 text-xs text-gray-655">
    ...
    function switchDisplayMode(mode) {
        ...
        if (mode === 'grid') {
            ...
            cards.forEach(card => {
                ...
                if (desc) desc.className = "text-xs text-gray-550 leading-normal line-clamp-2 summary-text";
            });
