...
<body class="min-h-screen bg-navyDeep text-white relative flex flex-col overflow-y-auto antialiased">
    ...
    <div class="flex-1 w-full max-w-sm sm:max-w-md mx-auto flex flex-col justify-center items-center px-4 py-10 relative z-10 my-auto">
        
        <!-- Main Card Container -->
        <div class="w-full bg-white/[0.03] border border-white/[0.08] p-6 sm:p-8 rounded-3xl shadow-2xl text-center space-y-6 sm:space-y-8 backdrop-blur-xl">
            ...
            <div class="space-y-3 bg-white/[0.02] border border-white/[0.05] p-3.5 sm:p-4 rounded-2xl">
                ...
                <p class="text-[10px] text-gray-400/85 italic font-medium leading-relaxed">Bàn giao & kích hoạt lại trong 15-30 phút tới</p>
            </div>
