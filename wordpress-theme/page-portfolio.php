...
<main class="flex-1 py-16 px-6 md:px-12 max-w-7xl mx-auto w-full font-sans text-gray-800 relative bg-[#FAFAF7]">
    <div class="max-w-7xl mx-auto space-y-12">
                    ...
                    switch($type) {
                        ...
                        default:
                            ...
                            <div class="w-full h-48 bg-gradient-to-tr from-[#F5F0E8] to-[#E5E7EB] flex flex-col items-center justify-center p-6 text-[#1A1A2E] text-center border-b border-gray-200 select-none">
                                ...
                                <span class="text-[10px] uppercase tracking-widest text-gray-650 font-bold font-mono font-mono">Crawler Indexer Nodes</span>
                ...
                while ($portfolio_query->have_posts()) {
                    ...
                    <div class="case-study-card bg-white border border-gray-200 rounded-lg overflow-hidden hover:border-[#FFD700] hover:shadow-lg transition-all flex flex-col justify-between group duration-300 cursor-pointer"
                        ...
                        <?php if ($thumbnail_url) { ?>
                            <div class="w-full h-48 overflow-hidden border-b border-gray-100 pointer-events-none">
        ...
        <div class="bg-[#1A1A2E] text-white p-8 md:p-12 rounded-lg text-center space-y-6 relative overflow-hidden">
            <div class="absolute top-0 left-0 w-32 h-32 bg-[#FFD700]/5 rounded-full blur-2xl font-sans"></div>
            ...
            <div class="flex flex-wrap items-center justify-center gap-4">
                <a
                    ...
                    class="inline-flex items-center justify-center space-x-2 bg-[#FFD700] hover:bg-[#E6C200] text-[#1A1A2E] text-xs font-bold uppercase tracking-wide px-6 py-4.5 rounded shadow cursor-pointer h-12 animate-bounce"
                >
    ...
    <div class="bg-[#FDFBF7] text-[#1A1A2E] w-full max-w-3xl rounded-xl shadow-2xl border border-gray-200 overflow-hidden flex flex-col max-h-[92vh]">
        ...
        <div class="p-5 sm:p-8 space-y-8 overflow-y-auto max-h-[calc(92vh-140px)] scrollbar-thin">
            ...
            <div class="relative rounded-lg overflow-hidden border border-gray-200 bg-[#F4EFE6] px-4 py-8 text-center flex flex-col items-center justify-center">
                ...
                <div class="text-sm text-gray-500 font-mono mt-1">Lưu trữ Case Study Hệ thống • Độc bản Derek Flow</div>
            </div>

            <!-- Dynamic Metrics boxes -->
            <div class="grid grid-cols-3 gap-2.5 sm:gap-4 bg-[#F5F0E8] p-4 rounded-lg border border-gray-150">
                <div class="text-center">
                    <span id="modal-m1-lbl" class="text-[9px] sm:text-[10px] text-gray-500 font-bold block uppercase tracking-wide">METRIC 1</span>
                ...
                <div class="text-center border-l border-gray-300">
                    <span id="modal-m2-lbl" class="text-[9px] sm:text-[10px] text-gray-500 font-bold block uppercase tracking-wide">METRIC 2</span>
                    <span id="modal-m2-val" class="text-base sm:text-xl font-black text-[#1A1A2E]">VALUE 2</span>
                </div>
                <div class="text-center border-l border-gray-300">
                    <span id="modal-m3-lbl" class="text-[9px] sm:text-[10px] text-gray-500 font-bold block uppercase tracking-wide">METRIC 3</span>
            ...
            <div class="space-y-6 divide-y divide-gray-150">
                ...
                <div id="modal-section-initial-wrapper" class="space-y-3 pt-0">
                    ...
                    <p id="modal-initial-state" class="text-xs sm:text-[13.5px] text-gray-700 leading-relaxed text-justify pl-4 font-sans">
                ...
                <div id="modal-section-problem-wrapper" class="space-y-3 pt-5">
                    ...
                    <p id="modal-problem" class="text-xs sm:text-[13.5px] text-gray-700 leading-relaxed text-justify pl-4 font-sans">
                        Detailed Problems...
                    </p>
                ...
                <div id="modal-section-fix-wrapper" class="space-y-3 pt-5">
                    ...
                    <p id="modal-fix" class="text-xs sm:text-[13.5px] text-gray-700 leading-relaxed text-justify pl-4 font-sans">
                        Detailed Fixes...
                    </p>
        ...
        <div class="p-4 bg-[#F5F0E8] border-t border-gray-200 flex flex-col sm:flex-row items-center justify-between gap-3">
            <span class="text-[11px] text-gray-500 font-medium">Bản quyền phân phối dự án thuộc về Derek Flow®</span>
            <div class="flex gap-2 w-full sm:w-auto">
                ...
                <button onclick="closePortfolioModal()" class="flex-1 sm:flex-initial bg-white border border-gray-250 text-gray-650 hover:text-gray-850 text-[11px] font-bold uppercase tracking-wider px-5 py-2.5 rounded transition-all cursor-pointer">
                    Đóng lại
                </button>
            </div>
        </div>
            ...
            items.forEach(text => {
                if (text.trim()) {
                    ...
                    li.innerHTML = `
                        ...
                        <span class="leading-relaxed text-justify font-sans">${text.trim()}</span>
                    `;
